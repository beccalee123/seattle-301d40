...
function displayPics(){
  ...
  // Beccase we switched rando from a var to a let statement, rando is now limitied to the scope within its codeblock, and thus cannot be called outside of it without throwing an error.
  console.log(viewed);
